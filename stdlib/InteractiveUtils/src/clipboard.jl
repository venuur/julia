...
elseif Sys.iswindows()
    function clipboard(x::AbstractString)
        ...
        pdata = ccall((:GlobalAlloc, "kernel32"), stdcall, Ptr{UInt16}, (UInt16, Int32), 2 #=GMEM_MOVEABLE=#, sizeof(x_u16))
        ...
        pset = ccall((:SetClipboardData, "user32"), stdcall, Ptr{UInt16}, (UInt32, Ptr{UInt16}), 13, pdata)
